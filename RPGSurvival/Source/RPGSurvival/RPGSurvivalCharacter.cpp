...
//////////////////////////////////////////////////////////////////////////
// ARPGSurvivalCharacter

ARPGSurvivalCharacter::ARPGSurvivalCharacter()
{
...
void ARPGSurvivalCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void ARPGSurvivalCharacter::MoveForward(float Value)
{
...
void ARPGSurvivalCharacter::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
